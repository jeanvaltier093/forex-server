...
async function fetchData(apiKey, outputsize) {
  ...
  for (const pair of PAIRS) {
    try {
      const r = await fetch(`https://api.twelvedata.com/time_series?symbol=${pair}&interval=4h&outputsize=${outputsize}&apikey=${apiKey}`);
